...
export const Card = (props: CardProps) => {
    ...
    return (
        <a className="flex flex-col flex-1 col-span-4 transition bg-white shadow-2xl group rounded-3xl hover:cursor-pointer hover:scale-95 active:scale-90" href={href} title={title}>
