...
export const Card = (props: CardProps) => {
    ...
    return (
        <Link href={href} title={title}>
            <a className="relative z-0 flex-1 p-8 transition shadow-2xl group rounded-3xl hover:scale-95 active:scale-90 hover:-rotate-2 hover:cursor-pointer">
                <div className="absolute inset-0 -z-20 rounded-3xl">
                    ...
                    <Image className="rounded-3xl -z-30" src={imageSrc ?? "https://source.unsplash.com/_KsnSQoKhUQ"} layout="fill" objectFit="cover" alt={title + " background button image"} />
                </div>
