...
export const Card = (props: CardProps) => {
    ...
    const { children, imageSrc, gradientOrientation } = props;

    return (
        <a className="relative z-0 flex-1 p-8 transition shadow-2xl group rounded-3xl hover:scale-95 active:scale-90 hover:-rotate-2 hover:cursor-pointer" href="#">
