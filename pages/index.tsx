...
const Home: NextPageWithLayout = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen px-6 py-6 md:py-24">
        ...
        <div className="flex flex-col flex-1 gap-4 md:flex-row max-h-[720px]">
          <Card href="/me" imageSrc="/images/moto.jpg" title="About me">
            <div className="flex flex-col-reverse items-end h-full">
              <h2 className="font-sans text-3xl text-white fond-bold">
                À propos de moi
              </h2>
            </div>
          </Card>
          ...
          <div className="flex flex-col flex-1 gap-4">
            <Card
              href="#"
              gradientOrientation={GradientOrientation.Up}
              title="Projects"
            >
